...
import { FbRegistrar, FirebaseLogin } from './firebaseC';
	...
	<div className="login-content">
            ...
            <form onSubmit={iniciarSesion}>
                <div className="row">
                     <label for="email">
                        Email:
                        <input type="email" name="email" id="username" placeholder="" onChange={newFuntion} />
                    </label>
                </div>
                ...
                <div className="row">
                    <label for="password">
                        Password:
                        <input type="password" name="password" onChange={newFuntion} id="password" placeholder="******"  />
                    </label>
                </div>
                <div className="row">
    ...
    <form className='row' onSubmit={registrarUsuario}>
                <div className="row">
                         <label for="username-2">
                            Username:
                            <input type="text" name="username" id="username-2" onChange={newFuntion}
                            placeholder=""  />
                        </label>
                    </div>
                    ...
                    <div className="row">
                        <label for="email-2">
                            your email:
                            <input type="email" name="email" id="email-2" placeholder=""  onChange={newFuntion}
                             />
                        </label>
                    </div>
                     <div className="row">
                        <label for="password-2">
                            Password:
                            <input type="password" name="password" id="password-2" placeholder=""  onChange={newFuntion}
                              />
                        </label>
                    </div>
            ...
            <nav className="navbar navbar-default navbar-custom">
                    ...
                    <div className="collapse navbar-collapse flex-parent" id="bs-example-navbar-collapse-1">
                        <ul className="nav navbar-nav flex-child-menu menu-left">
                            ...
                            <li className="dropdown first">
                                ...
                                <ul className="dropdown-menu level1">
                                    ...
                                    <li><a href="/register">Home 02</a></li>
                                    <li><a href="/lPelis">Listado</a></li>
                                </ul>
                            </li>
                            <li className="dropdown first">
                                ...
                                <ul className="dropdown-menu level1">
                                    ...
                                    <li className="it-last"><a href="blog">Ir al blog</a></li>
                                </ul>
                            </li>
                            <li className="dropdown first">
                                <a className="btn btn-default dropdown-toggle lv1" data-toggle="dropdown" data-hover="dropdown">
                        ...
                        <ul className="nav navbar-nav flex-child-menu menu-right">
                            ...
                            <li className="btn signupLink"><a href="/register">sign up</a></li>
                        </ul>
                    </div>
